    ...
    <div className="min-h-screen flex items-center py-24 px-6 bg-sv-panel-dark">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-sv-text-light">Three steps to your AI-powered office.</p>
        </div>

        {/* Steps */}
        <div className="space-y-8 md:space-y-0 md:grid md:grid-cols-3 md:gap-8 mb-16">
          {steps.map((step, i) => (
            <div key={i} className="relative text-center">
              ...
              <div className="relative inline-block mb-6">
                <div className="sv-box w-28 h-28 flex items-center justify-center">
                  <span className="text-5xl">{step.icon}</span>
                </div>
                <span className="absolute -top-3 -right-3 w-8 h-8 rounded-full bg-sv-orange border-3 border-[#b85c10] text-white text-xs font-[var(--font-pixel)] flex items-center justify-center shadow-md">
                  {step.num}
                </span>
              </div>

              <h3 className="font-[var(--font-pixel)] text-[10px] text-sv-brown mb-3 leading-relaxed">{step.title}</h3>
        ...
        {/* Video preview */}
        <div className="sv-box p-3 max-w-4xl mx-auto">
